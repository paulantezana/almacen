<?php
    ...
    class ClienteController extends Controller{
        public function paginate(){
            ...
            $total = $consult -> query('SELECT * FROM  clientes  WHERE razon_social LIKE :search',[
                ':search'       => '%' . $request->search . '%',
            ])->rowCount();

            // Realizando la consulta con la paginacion
            $clientes = $consult -> query("SELECT * FROM  clientes WHERE razon_social LIKE :search ORDER BY id DESC LIMIT {$offset}, {$request->limit}",[
                ':search'       => '%' . $request->search . '%',
        ...
        public function index(){
            echo $this->view->render('admin/cliente/index.twig');
        }
        public function form(){
            ...
            if(isset($_GET['id'])){
                ...
                $result = $consult -> query(
                    'SELECT * FROM  clientes WHERE id=:id', [':id'   => $_GET['id']]
                );
            ...
            // redireccionamiento
            echo $this->view->render('admin/cliente/form.twig',[
                'cliente' => $cliente,
        ...
        public function create(){
            $consult = new Consult();
            $consult -> query(
                'INSERT INTO clientes (razon_social,tipo_documento,numero_documento,direccion,telefono,email,representante,logo,estado)
