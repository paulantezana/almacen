<?php
    ...
    class CreditoController extends Controller{
        public function paginate(){
            ...
            $total = $consult -> query('SELECT * FROM  creditos  WHERE razon_social LIKE :search',[
                ':search'       => '%' . $request->search . '%',
            ])->rowCount();

            // Realizando la consulta con la paginacion
            $creditos = $consult -> query("SELECT * FROM  creditos WHERE razon_social LIKE :search ORDER BY id DESC LIMIT {$offset}, {$request->limit}",[
                ':search'       => '%' . $request->search . '%',
        ...
        public function index(){
            echo $this->view->render('admin/credito/index.twig');
        }
        public function form(){
            ...
            if(isset($_GET['id'])){
                ...
                $result = $consult -> query(
                    'SELECT * FROM  creditos WHERE id=:id', [':id'   => $_GET['id']]
                );
            ...
            // redireccionamiento
            echo $this->view->render('admin/credito/form.twig',[
                'credito' => $credito,
        ...
        public function create(){
            $consult = new Consult();
            $consult -> query(
                'INSERT INTO creditos (razon_social,tipo_documento,numero_documento,direccion,telefono,email,representante,logo,estado)
