<?php
    ...
    class IngresoController extends Controller{
        public function paginate(){
            ...
            $total = $consult -> query('SELECT * FROM  ingresos  WHERE razon_social LIKE :search',[
                ':search'       => '%' . $request->search . '%',
            ])->rowCount();

            // Realizando la consulta con la paginacion
            $ingresos = $consult -> query("SELECT * FROM  ingresos WHERE razon_social LIKE :search ORDER BY id DESC LIMIT {$offset}, {$request->limit}",[
                ':search'       => '%' . $request->search . '%',
        ...
        public function index(){
            echo $this->view->render('admin/ingreso/index.twig');
        }
        public function form(){
            ...
            if(isset($_GET['id'])){
                ...
                $result = $consult -> query(
                    'SELECT * FROM  ingresos WHERE id=:id', [':id'   => $_GET['id']]
                );
            ...
            // redireccionamiento
            echo $this->view->render('admin/ingreso/form.twig',[
                'ingreso' => $ingreso,
        ...
        public function create(){
            $consult = new Consult();
            $consult -> query(
                'INSERT INTO ingresos (razon_social,tipo_documento,numero_documento,direccion,telefono,email,representante,logo,estado)
