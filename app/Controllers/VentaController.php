<?php
    ...
    class VentaController extends Controller{
        public function paginate(){
            ...
            $total = $consult -> query('SELECT * FROM  ventas  WHERE razon_social LIKE :search',[
                ':search'       => '%' . $request->search . '%',
            ])->rowCount();

            // Realizando la consulta con la paginacion
            $ventas = $consult -> query("SELECT * FROM  ventas WHERE razon_social LIKE :search ORDER BY id DESC LIMIT {$offset}, {$request->limit}",[
                ':search'       => '%' . $request->search . '%',
        ...
        public function index(){
            echo $this->view->render('admin/venta/index.twig');
        }
        public function form(){
            ...
            if(isset($_GET['id'])){
                ...
                $result = $consult -> query(
                    'SELECT * FROM  ventas WHERE id=:id', [':id'   => $_GET['id']]
                );
            ...
            // redireccionamiento
            echo $this->view->render('admin/venta/form.twig',[
                'venta' => $venta,
        ...
        public function create(){
            $consult = new Consult();
            $consult -> query(
                'INSERT INTO ventas (razon_social,tipo_documento,numero_documento,direccion,telefono,email,representante,logo,estado)
